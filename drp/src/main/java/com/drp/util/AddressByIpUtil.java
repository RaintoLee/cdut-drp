		...
		public static String getAddresses(String content, String encodingString)
			...
			if (returnStr != null) {
				...
				if(temp.length<3){
					...
					String[] address1 =  temp[7].split(":");
					address = address1[1].substring(1, address1[1].length()-1);
				}
				return address;
			}
			return null;
...
//				String address = AddressByIpUtil.getAddresses("ip=219.136.134.157"+"&ak="+"H1DOkgEyoqePW8Z6ahp6GPQq8excwvh0", "utf-8");
