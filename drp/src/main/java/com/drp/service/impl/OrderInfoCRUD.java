...
public class OrderInfoCRUD extends RecordServiceImpl<ProtocolVO>{

	@Override
	public void createDocument(ProtocolVO protocolVO) throws IOException{
...
//		System.out.println(response.getResult()); 
		...
		if(file.isDirectory()){
			...
			sb.append("createDocument,info,order,")
				.append(protocolVO.getAgmt_id()).append(",")
				.append(protocolVO.getAgent_num()).append(",")
				.append(protocolVO.getAuth_fee()).append(",")
				.append(protocolVO.getDeskey()).append(",")
				.append(protocolVO.getInfo_isvalid_flg()).append(",")
				.append(protocolVO.getParta_id()).append(",")
				.append(protocolVO.getParta_patio()).append(",")
				.append(protocolVO.getPartb_id()).append(",")
				.append(protocolVO.getPartb_patio()).append(",")
				.append(protocolVO.getProtocol_deadline()).append(",")
				.append(protocolVO.getProtocol_type()).append(",")
				.append(protocolVO.getReceive_flg()).append(",")
				.append(protocolVO.getRole_id()).append(",")
				.append(protocolVO.getUsr_id()).append(",")
				.append(protocolVO.getWorks_id()).append(",")
				.append("0").append("\n");
	...
	@Override
	public void updateDocument(ProtocolVO protocolVO) throws IOException{
...
//		System.out.println(response.getResult());  
		...
		if(file.isDirectory()){
			...
			StringBuffer sb = new StringBuffer();
			sb.append("updateDocument,info,order,")
				.append(protocolVO.getAgmt_id()).append(",")
				.append(protocolVO.getInfo_isvalid_flg()).append(",")
				.append(protocolVO.getReceive_flg()).append("\n");
			out.write(sb.toString().getBytes());
	...
	@Override
	public void deleteDocument(ProtocolVO protocolVO) throws IOException{
//		UpdateResponse response = client.prepareUpdate("info", "order", protocolVO.getAgmt_id())
//				.setDoc(XContentFactory.jsonBuilder()
//					.startObject()
//						.field("isdelete", "1")
...
//		System.out.println(response.getResult());  
		...
		if(file.isDirectory()){
			...
			StringBuffer sb = new StringBuffer();
			sb.append("deleteDocument,info,order,")
				.append(protocolVO.getAgmt_id()).append(",")
				.append("1").append("\n");
			out.write(sb.toString().getBytes());
		}
