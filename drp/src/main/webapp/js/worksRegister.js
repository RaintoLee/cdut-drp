...
$(function() {
	...
	$("#loginBtn").click(function() {
		...
		var workTheme = $("#worksTheme").val();
		var workKeyword = $("#worksKeyWords").val();
	    ...
	    reader.onload=function(f){
	    	...
	    	if (!fileSize) {
				...
				alert("请填写作品大小！");
				return false;
			} else if (!$.trim(workTheme)) {
				alert("请填作品主题！");
				return false;
			} else if (!$.trim(workKeyword)) {
				alert("请填作品关键字！");
				return false;
